...
MODEL = NetworkRLadder(topology=Topology([
    ...
    {'type': 'lconvgru',      'input_shape': (32, 32, 64),   'shape': (5, 5, 64, 128)},
    {'type': 'lconvgru',      'input_shape': (32, 32, 128),  'shape': (5, 5, 128, 128)},
    {'type': 'pooling',       'pool_size': (2, 2)},
    {'type': 'lconvgru',      'input_shape': (16, 16, 128),  'shape': (5, 5, 128, 256)},
    {'type': 'lconvgru',      'input_shape': (16, 16, 256),  'shape': (5, 5, 256, 256)},
    {'type': 'pooling',       'pool_size': (2, 2)},
    {'type': 'lconvgru',      'input_shape': (8, 8, 256),    'shape': (3, 3, 256, 512)},
    {'type': 'lconvgru',      'input_shape': (8, 8, 512),    'shape': (3, 3, 512, 512)},
    {'type': 'pooling',       'pool_size': (2, 2)},
    {'type': 'lconvgru',      'input_shape': (4, 4, 512),    'shape': (3, 3, 512, 256)},
    {'type': 'lconvgru',      'input_shape': (4, 4, 256),    'shape': (3, 3, 256, 256)},
