...
from network import NetworkRLadder
...
SAVE_ROOT = './save/ucf101_rladder/'
SAVE_PATH = SAVE_ROOT + 'model/model'
TRAIN_STEPS = 500000
BATCH_SIZE = 6
DEVICE = '/gpu:0'

MODEL = NetworkRLadder(topology=Topology([
    ...
    {'type': 'lconvgru',      'input_shape': (32, 40, 64),   'shape': (5, 5, 64, 128)},
    {'type': 'lconvgru',      'input_shape': (32, 40, 128),  'shape': (5, 5, 128, 128)},
    {'type': 'pooling',       'pool_size': (2, 2)},
    {'type': 'lconvgru',      'input_shape': (16, 20, 128),  'shape': (5, 5, 128, 256)},
    {'type': 'lconvgru',      'input_shape': (16, 20, 256),  'shape': (5, 5, 256, 256)},
    {'type': 'pooling',       'pool_size': (2, 2)},
    {'type': 'lconvgru',      'input_shape': (8, 10, 256),   'shape': (3, 3, 256, 512)},
    {'type': 'lconvgru',      'input_shape': (8, 10, 512),   'shape': (3, 3, 512, 512)},
    {'type': 'pooling',       'pool_size': (2, 2)},
    {'type': 'lconvgru',      'input_shape': (4, 5, 512),    'shape': (3, 3, 512, 256)},
    {'type': 'lconvgru',      'input_shape': (4, 5, 256),    'shape': (3, 3, 256, 256)},
